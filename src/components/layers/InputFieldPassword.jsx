...
const InputFieldPassword = ({className,placeholder,label,id,classNameforplaceholder}) => {
  ...
  return (
    ...
    <input id={id} className={`lg:pt-[33px] md:pt-5 sm:pt-4 pt-3 md:pb-4 sm:pb-3 pb-2 lg:text-sm sm:text-xs text-[10px] font-DM text-[#767676] outline-none ${classNameforplaceholder}`} type={eye?"password":"text"} placeholder={placeholder} />
    {
